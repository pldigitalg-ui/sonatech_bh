...
<head>
  ...
  <title>Xiaomi Prime | Smartphones, Acessórios e Assistência</title>
  <meta name="description" content="Loja premium de celulares, acessórios e assistência técnica com visual inspirado em grandes marcas, carrinho funcional e compra rápida no WhatsApp." />
  <meta name="keywords" content="xiaomi, loja de celular, smartphone, acessórios, assistência técnica, carrinho, whatsapp" />
...
<body>
  <header class="site-header" id="topo">
    <div class="container nav-wrap">
      <a href="#inicio" class="brand" aria-label="Xiaomi Prime">
        <span class="brand-badge">Mi</span>
        <span class="brand-text">Xiaomi Prime</span>
      </a>
      ...
      <div class="nav-actions">
        <button class="icon-btn" id="searchBtn" aria-label="Pesquisar">⌕</button>
        <button class="icon-btn cart-trigger" id="cartTrigger" aria-label="Abrir carrinho">
          🛒
          <span class="cart-badge" id="cartBadge">0</span>
        </button>
        <a class="btn btn-dark desktop-cta" href="https://wa.me/5531999999999?text=Olá!%20Quero%20atendimento." target="_blank" rel="noopener noreferrer">Atendimento</a>
    ...
    <div class="mobile-menu" id="mobileMenu">
      ...
      <a href="#assistencia">Assistência</a>
      <a href="#contato">Contato</a>
      <a class="btn btn-primary" href="https://wa.me/5531999999999?text=Olá!%20Quero%20atendimento." target="_blank" rel="noopener noreferrer">Chamar no WhatsApp</a>
    </div>
  </header>
  ...
  <main>
    <section class="hero" id="inicio">
      <div class="hero-slides">
        <div class="hero-slide active" style="background-image:url('https://placehold.co/1600x780/f4f7fb/111111?text=Hero+1');"></div>
        <div class="hero-slide" style="background-image:url('https://placehold.co/1600x780/edf2f8/111111?text=Hero+2');"></div>
        <div class="hero-slide" style="background-image:url('https://placehold.co/1600x780/f8fbff/111111?text=Hero+3');"></div>
      </div>

      <div class="container hero-inner">
        <div class="hero-copy">
          <span class="hero-kicker">NOVO DESTAQUE</span>
          <h1>Smartphones com visual premium e compra fácil</h1>
          <p>Site claro, elegante e direto. Produto em destaque, vitrine forte e fechamento rápido no WhatsApp.</p>
          <div class="hero-actions">
            <a href="#produtos" class="btn btn-primary">Ver produtos</a>
            <a href="https://wa.me/5531999999999?text=Olá!%20Quero%20comprar%20agora." class="btn btn-light" target="_blank" rel="noopener noreferrer">Comprar no WhatsApp</a>
          </div>
        </div>
      </div>
    ...
    <section class="section" id="destaques">
      <div class="container">
        <div class="section-head center">
          ...
          <h2>Estilo premium com cara de loja grande</h2>
          <p>Visual claro, topografia forte e estrutura pronta para trocar pelas fotos reais depois.</p>
        </div>
        ...
        <div class="highlight-grid">
          <article class="highlight-main">
            ...
            <div class="highlight-content">
              ...
              <h3>Celulares com presença forte na vitrine</h3>
              <p>Bloco principal para chamar atenção logo de cara e empurrar o clique.</p>
          ...
          <div class="highlight-side">
            <article class="small-card">
              <h4>Acessórios</h4>
              <p>Capinhas, cabos, fontes e mais.</p>
              <a href="#produtos" class="text-link">Ver seção</a>
            </article>
            <article class="small-card">
              <h4>Assistência</h4>
              <p>Troca de tela, bateria e orçamento.</p>
    ...
    <section class="section products-section" id="produtos">
      <div class="container">
        <div class="section-head">
          ...
          <p>Agora com carrinho funcional, botão de compra e abertura correta.</p>
        </div>
        ...
        <div class="category-pills">
          ...
          <button class="pill" type="button">Smartwatch</button>
        </div>

        <div class="products-grid">
          <article class="product-card">
            <div class="product-image">
              <img src="https://placehold.co/720x720/f6f8fc/111111?text=Smartphone+Pro" alt="Smartphone Pro" loading="lazy">
              <span class="floating-label">Mais vendido</span>
            </div>
            <div class="product-body">
              <h3>Smartphone Pro</h3>
              <p>Design premium, câmera forte e bateria duradoura.</p>
              <div class="price-row">
                <strong>R$ 1.999</strong>
                <span>12x sem juros</span>
              </div>
              <div class="product-actions-grid">
                <button class="btn btn-light add-cart" data-product="Smartphone Pro" data-price="1999" data-image="https://placehold.co/720x720/f6f8fc/111111?text=Smartphone+Pro">Adicionar</button>
                <button class="btn btn-primary buy-now" data-product="Smartphone Pro" data-price="1999" data-image="https://placehold.co/720x720/f6f8fc/111111?text=Smartphone+Pro">Comprar agora</button>
              </div>
            </div>
          </article>
          ...
          <article class="product-card">
            <div class="product-image">
              <img src="https://placehold.co/720x720/f6f8fc/111111?text=Redmi+Note" alt="Redmi Note" loading="lazy">
              <span class="floating-label">Oferta</span>
            </div>
            <div class="product-body">
              <h3>Redmi Note</h3>
              <p>Ótimo custo-benefício e visual elegante.</p>
              <div class="price-row">
                <strong>R$ 1.499</strong>
                <span>Entrega rápida</span>
              </div>
              <div class="product-actions-grid">
                <button class="btn btn-light add-cart" data-product="Redmi Note" data-price="1499" data-image="https://placehold.co/720x720/f6f8fc/111111?text=Redmi+Note">Adicionar</button>
                <button class="btn btn-primary buy-now" data-product="Redmi Note" data-price="1499" data-image="https://placehold.co/720x720/f6f8fc/111111?text=Redmi+Note">Comprar agora</button>
              </div>
            </div>
          </article>
          ...
          <article class="product-card">
            ...
            <div class="product-body">
              ...
              <p>Proteção, visual bonito e venda rápida.</p>
              <div class="price-row">
    ...
    <section class="section assistance-section" id="assistencia">
      <div class="container assistance-grid">
        <div class="assistance-copy">
          ...
          <h2>Conserto com atendimento rápido</h2>
          <p>Bloco pronto para orçamento e venda de serviço com cara profissional.</p>
          <ul>
            <li>Troca de tela</li>
          ...
          <a href="https://wa.me/5531999999999?text=Olá!%20Quero%20um%20orçamento%20de%20conserto." class="btn btn-primary" target="_blank" rel="noopener noreferrer">Pedir orçamento</a>
        </div>
    ...
    <section class="section" id="contato">
      <div class="container contact-grid">
        <div class="contact-box">
          ...
          <p>Troque depois pelos dados reais da empresa.</p>
          <div class="contact-item"><strong>WhatsApp</strong><span>(31) 99999-9999</span></div>
          <div class="contact-item"><strong>Endereço</strong><span>Rua Exemplo, 123 - Belo Horizonte - MG</span></div>
          <div class="contact-item"><strong>Horário</strong><span>Seg a Sáb • 08h às 18h</span></div>
        </div>
        <div class="map-box">
          <iframe title="Mapa" src="https://www.google.com/maps?q=Belo%20Horizonte%20MG&output=embed" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
      </div>
    </section>
  </main>
  ...
  <footer class="site-footer">
    <div class="container footer-wrap">
      <div>
        <h3>Xiaomi Prime</h3>
        <p>Celulares, acessórios e assistência técnica.</p>
      </div>
  ...
  <a class="floating-whatsapp" id="floatingWhatsapp" href="https://wa.me/5531999999999?text=Olá!%20Quero%20atendimento." target="_blank" rel="noopener noreferrer">WhatsApp</a>
...
.brand-badge{
  ...
  background:linear-gradient(135deg,#ff7a00,#ff9a32);color:#fff;box-shadow:0 12px 25px rgba(255,122,0,.25)
}
.brand-text{font-family:'Manrope',sans-serif;font-size:1.05rem}
...
.icon-btn{
  ...
  background:#f4f7fb;border:1px solid rgba(15,17,21,.06);position:relative
}
.cart-badge{
  position:absolute;top:-4px;right:-2px;min-width:22px;height:22px;padding:0 6px;border-radius:999px;
  display:grid;place-items:center;background:var(--primary);color:#fff;font-size:.75rem;font-weight:800
}
.menu-toggle{
  display:none;width:46px;height:46px;border-radius:14px;background:#f4f7fb;border:1px solid rgba(15,17,21,.06);
  align-items:center;justify-content:center;flex-direction:column;gap:5px
}
.menu-toggle span{width:20px;height:2px;background:#111;border-radius:999px}
.mobile-menu{display:none;flex-direction:column;gap:14px;padding:0 16px 18px;background:#fff;border-top:1px solid rgba(15,17,21,.06)}
.mobile-menu.active{display:flex}
.mobile-menu a{font-weight:600;color:#2c3440}

.btn{
  display:inline-flex;align-items:center;justify-content:center;min-height:52px;padding:0 22px;border-radius:14px;
  font-weight:800;transition:.25s ease;border:1px solid transparent
}
.btn:hover{transform:translateY(-2px)}
.btn-primary{background:linear-gradient(135deg,var(--primary),var(--primary-2));color:#fff;box-shadow:0 14px 30px rgba(23,144,255,.22)}
.btn-light{background:#fff;color:#111;border-color:#dbe4ef}
.btn-dark{background:#111;color:#fff}
.btn-full{width:100%}

.hero{position:relative;min-height:78vh;overflow:hidden;background:#f3f6fb;border-bottom:1px solid rgba(15,17,21,.06)}
...
.hero-copy{max-width:560px;padding:80px 0}
...
.hero h1{font-family:'Manrope',sans-serif;font-size:clamp(2.6rem,5vw,4.9rem);line-height:.94;letter-spacing:-.06em;margin-bottom:16px;max-width:10ch}
...
.strip{padding:18px 0;background:#fff;border-bottom:1px solid rgba(15,17,21,.06)}
.strip-grid{display:grid;grid-template-columns:repeat(4,1fr);gap:14px}
.strip-grid div{
  min-height:56px;display:grid;place-items:center;text-align:center;background:#f7f9fc;border:1px solid #e4ebf3;border-radius:16px;font-weight:700
}
...
.section-head h2{font-family:'Manrope',sans-serif;font-size:clamp(2rem,4vw,3.2rem);line-height:1.02;letter-spacing:-.05em;margin-bottom:12px}
.section-head p{color:var(--muted)}

.highlight-grid{display:grid;grid-template-columns:1.2fr .8fr;gap:22px}
.highlight-main{
  min-height:380px;position:relative;overflow:hidden;border-radius:32px;box-shadow:var(--shadow);border:1px solid #e2e8f0;
  background:url('https://placehold.co/1400x920/f2f6fb/111111?text=Linha+Premium') center/cover no-repeat
}
.highlight-overlay{position:absolute;inset:0;background:linear-gradient(180deg, rgba(255,255,255,.05), rgba(255,255,255,.10))}
...
.mini-tag{display:inline-block;margin-bottom:10px;color:var(--primary);font-size:.82rem;font-weight:800;text-transform:uppercase;letter-spacing:.08em}
...
.assistance-copy{padding:30px;border-radius:30px;background:#fff;border:1px solid #e4ebf3;box-shadow:var(--shadow)}
.assistance-copy h2{font-family:'Manrope',sans-serif;font-size:clamp(2rem,4vw,3rem);line-height:1.02;letter-spacing:-.05em;margin-bottom:12px}
.assistance-copy p{color:var(--muted);margin-bottom:20px}
...
.contact-box{padding:30px;border-radius:30px;background:#fff;border:1px solid #e4ebf3;box-shadow:var(--shadow)}
.contact-box h2{font-family:'Manrope',sans-serif;font-size:clamp(2rem,4vw,2.9rem);line-height:1.02;letter-spacing:-.05em;margin-bottom:12px}
...
.site-footer{padding:34px 0;background:#fff;border-top:1px solid rgba(15,17,21,.06)}
...
.floating-whatsapp{
  position:fixed;right:18px;bottom:18px;z-index:999;min-height:56px;padding:0 20px;border-radius:999px;
  display:inline-flex;align-items:center;justify-content:center;background:linear-gradient(135deg,#111,#2a2a2a);color:#fff;font-weight:900;box-shadow:0 18px 40px rgba(17,17,17,.18)
}
.back-to-top{
  position:fixed;right:18px;bottom:84px;width:48px;height:48px;border-radius:50%;background:#fff;border:1px solid #dde5ef;
  display:grid;place-items:center;box-shadow:var(--shadow);opacity:0;visibility:hidden;transition:.25s ease;z-index:998
}
.back-to-top.show{opacity:1;visibility:visible}

.cart-overlay,.modal-overlay{
  position:fixed;inset:0;background:rgba(15,17,21,.35);backdrop-filter:blur(3px);opacity:0;visibility:hidden;transition:.25s ease;z-index:1190
}
.cart-overlay.active,.modal-overlay.active{opacity:1;visibility:visible}
.cart-drawer,.side-modal{
  position:fixed;top:0;right:-100%;width:100%;max-width:440px;height:100vh;background:#fff;border-left:1px solid #e2eaf3;box-shadow:-12px 0 40px rgba(17,17,17,.08);transition:right .32s ease;z-index:1200;display:flex;flex-direction:column
}
...
.close-btn{
  width:42px;height:42px;border-radius:50%;display:grid;place-items:center;background:#f6f9fc;border:1px solid #e2eaf3
}
...
.qty-btn{
  width:32px;height:32px;border-radius:50%;display:grid;place-items:center;background:#fff;border:1px solid #dbe4ef;font-weight:800
}
...
.form-grid input,.form-grid select,.form-grid textarea{
  width:100%;padding:14px 16px;border-radius:14px;border:1px solid #dce5ef;background:#f8fbff;color:#111;outline:none
}
...
@media (max-width:640px){
  ...
  .hero h1{font-size:clamp(2.1rem,8vw,3rem);max-width:10ch}
...
checkoutWhatsapp?.addEventListener('click', () => {
  ...
  const url = `https://wa.me/5531999999999?text=${encodeURIComponent(lines.join('\n'))}`;
...
* `5531999999999` pelo WhatsApp real
* imagens `placehold.co` pelas imagens reais
* endereço da loja
* mapa
